...
function play(s){if(!enabled)return;stopAudio();if(!s.audio){fallbackBeep();return}const a=new Audio(s.audio+'?v=21');a.preload='auto';a.volume=1;currentAudio=a;const p=a.play();if(p&&p.catch)p.catch(()=>fallbackBeep())}
